<form class="mt-4" method="POST" action="{{ route('storeGuideArticle') }}" enctype="multipart/form-data">
    ...
    <div class="row mt-3">
        <label for="imageCredit7">Image Credit 7</label>
    </div>
    <div class="row">
            <!-- <label for="title" class="control-label">Article Image</label> -->
            <input type="text" name="imageCredit7" class="form-control form-control-lg" placeholder="A cool image here">    
    </div>
    ...
    <div class="row mt-3">
        <label for="imageCredit8">Image Credit 8</label>
    </div>
    <div class="row">
            <!-- <label for="title" class="control-label">Article Image</label> -->
            <input type="text" name="imageCredit8" class="form-control form-control-lg" placeholder="Image Credit here">    
    </div>
    ...
    <div class="row mt-3">
        <label for="imageCredit9">Image Credit 9</label>
    </div>
    <div class="row">
            <!-- <label for="title" class="control-label">Article Image</label> -->
            <input type="text" name="imageCredit9" class="form-control form-control-lg" placeholder="image credit here">    
    </div>
    ...
    <div class="row mt-3">
     ...
     <div class="row">
            <input type="text" name="image10" class="form-control form-control-lg" placeholder="A cool image here">    
    </div>
    <div class="row mt-3">
        <label for="image10">Image Credit 10</label>
    </div> 

    <div class="row">
        <!-- <label for="title" class="control-label">Article Image</label> -->
        <input type="text" name="imageCredit10" class="form-control form-control-lg" placeholder="image credit here">    
    </div>
