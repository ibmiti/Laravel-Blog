...
<head>
    ...
    <title>BabyBassinet - Blog {{ $healthArticle->title ?? '' }} </title>
</head>
<style>
...
<strong class="navbar-brand" 
    ...
    href="#">BB + BABY BLOG | ARTICLE {{ $healthArticle->id ?? '' }}
</strong>   
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent15">
    <ul class="navbar-nav ml-auto"> 
        <?php     
            ...
            $healthArticleId = $healthArticle->id ?? '';
            
            switch ($uri) {
                case ($uri == '/articles'. '/'. $healthArticleId):
